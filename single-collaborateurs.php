<?php get_header();?>
  ...
  <div class="card-image">
    <figure class="image is-4by3">
      ...
      <img src="<?php echo $photo['sizes']['fullscreen'];?>" alt="<?php echo $photo['alt'];?>" class="photo-collaborateur" style="width:<?php echo $photo['sizes']['fullscreen-width'];?>px; height:<?php echo $photo['sizes']['fullscreen-height'];?>px;">
    </figure>
  </div>
  <div class="card-content">
    <div class="media">
      <div class="media-content">
        <p class="title is-4"><?php the_field('collaborateurs-prenom');?> <?php the_field('collaborateurs-nom');?></p>
